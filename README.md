...
| `MissingAutoVerifyAttribute`         | [`MissingAutoVerifyDetector`](checks/src/main/java/com/example/lint/checks/MissingAutoVerifyDetector.kt)         | Failing to implement App Links verification leaves the app susceptible to the risk of Insecure Deep Links, potentially allowing other applications to hijack the domain's web URLs and intercept traffic intended for the legitimate app.                                                                         |
